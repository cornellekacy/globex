...
<!-- Mirrored from themezinho.net/shipper/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jan 2020 06:30:50 GMT -->
<head>
<meta charset="utf-8">
...
<link href="fav1.png" rel="shortcut icon">
...
<main>
  <aside class="side-box hidden-sm"> <span class="close-side-box"><i class="ion-close"></i></span>
    <div class="side-about">
      ...
      <figure><img src="log1.png" alt="Image"></figure>
      ...
      <div class="top-bar">
        <div class="container">
          <div class="row">
            ...
            <!-- end col-3 -->
            <div class="col-md-3 col-sm-4 col-xs-8"> <span class="date">12 Mar </span> <span class="weather"><i class="ion-ios-partlysunny"></i> 15°</span> <span class="phone"><i class="ion-ios-telephone"></i> +1 (813) 360-1872</span> </div>
            <!-- end col-3 --> 
          </div>
          <!-- end row --> 
        </div>
      ...
      <div class="container">
        <div class="navbar-header">
          <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12">
              ...
              <a class="navbar-brand" href="index-2.html"><img src="log1.png" alt="Image"></a> </div>
            <!-- end col-5 -->
            ...
            <div class="col-md-3 col-sm-4 hidden-xs"> <i class="icon-map-pin"></i>
              <h6>OUR LOCATION<br>
                <span>LOS ANGELAS - CALIFORNIA</span></h6>
            </div>
            <!-- end col-2 -->
            <div class="col-md-3 hidden-sm hidden-xs"> <i class="icon-chat"></i>
              <h6>QUICK SUPPORT<br>
                <span>SUPPORT@GLOBEXSHIPPINGLOGISTICS.COM</span></h6>
            </div>
            <!-- end col-2 --> 
          </div>
          <!-- end row --> 
        ...
        <div class="collapse navbar-collapse cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav main-menu">
            ...
            <li><a href="track.php" class="transition">TRACKING</a></li>
         
            <li><a href="testimonial.php" class="transition">TESTIMONIALS</a></li>
            <li><a href="contact.php" class="transition">CONTACT</a></li>
            <li><a href="backend/index.php" class="transition">LOGIN</a></li>
          </ul>
